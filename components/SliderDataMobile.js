...
export const SliderData = [
    ...
    },
    {
        ...
        description:<p>Ridge et Sydney ont trouvé l'amour, malgré tous les obstacles qui s'étaient dressés entre eux, dans Maybe Someday.
        Leur histoire, ainsi que celle de tous leurs amis, se poursuit maintenant.<br/>
    ...
    },
    {
        ...
        description:<p>La vie a toujours souri à Verity Crawford.
        Ses livres font d'elle une auteur star, sa maison du Vermont est
        splendide et elle forme avec Jeremy, son mari, un couple parfait.
        Mais un jour, sur une route, son rêve tourne au cauchemar.
        L'accident l'empêche d'écrire, transforme sa trop grande maison
        en prison, et menace de l'éloigner de Jeremy.
        La vie n'a jamais été tendre avec Lowen ashleigh.
        Ses livres ne rencontrent qu'un accueil poli, ses finances sont au
        plus mal et ses histoires d'amour sont des feux de paille. Jusqu'à
        ce que Jeremy la recrute pour devenir le ghostwriter de Verity et
        terminer à sa place sa série à succès.<br/>
    ...
    },
    {
        ...
        description:<p>Merit Voss est une fille un peu bizarre. Elle collectionne, parexemple, des trophées qu'elle n'a pas gagnés. C'est en voulant en acquérir un nouveau dans une brocante qu'elle fait la
        connaissance d'un séduisant jeune homme : Sagan. Il lui plaît
        immédiatement mais elle va vite réaliser que l'alchimie qu'elle a
        perçue entre eux a peu de chances de se développer.<br/>
        Rien n'est jamais simple dans la famille Voss. Son père et sa mère
        sont séparés officiellement mais vivent encore sous le même toit,
        celui d'une église désaffectée. Elle supporte mal l'ambiance qui y
        règne entre des parents qui semblent l'ignorer et des frères et
        soeur dont elle se sent de moins en moins proche.Mais le pire est
        peut-être à venir quand elle découvre que les apparences sont
    ...
    //     description:`Thanatos est le dieu de la mort et le fils de Nyx, il travaille en tant que collectionneur d'âmes dans l’entreprise d’Hadès. Considéré comme un dieu paresseux par ses collègues, il en veut au mauvais traitement qu'il reçoit dans son travail, ce qui le pousse à avoir de mauvaises fréquentations comme Menthé et Thétis et agir de manière mesquine. Cela va d’ailleurs se diriger vers Perséphone, dont il est jaloux et n’apprécie pas son traitement. Cependant, il décide de s’améliorer et de reprendre sa vie en main, en coupant tous les liens avec ses anciens détracteurs.`,
    //     name:'Thanatos'
    // },
    // {
    //     image: '/images/09ZEUSDESKTOP.jpg',
    //     description:`Zeus est le dieu du Ciel et du Tonnerre, le roi des dieux, mari d’Héra et également membre de la dynastie des Six Traîtres. Effronté, têtu et faisant preuve de sarcasme envers ses frères, il s’entend cependant bien avec eux et souhaite les protéger. Il sera toujours à leur écoute et s’emploiera à les conseiller au mieux. Cependant, son côté égocentrique lui attire les foudres de son entourage qui considère qu’il souffre du syndrome de l’enfant unique. Jaloux et ayant peur du rapprochement entre Héra et Hadès, il n’hésite pas à intervenir pour le convaincre de devenir le roi des Enfers et superviseur de Kronos.`,
    //     name:'Zeus'
    // },
    // {
    //     image: '/images/08MENTHEDESKTOP.jpg',
    //     description:`Menthé est une nymphe fluviale des Enfers, secrétaire à Underworld Corp et assistante personnelle d'Hadès ainsi que son ex-petite amie. Elle a une personnalité très autodestructrice : très peu sûre d'elle et incapable d’accepter la gentillesse, elle sait aussi se montrer manipulatrice. Devant l’attachement d'Hadès pour Perséphone, elle ressent une véritable jalousie. Même si elle lutte contre ses démons et souhaite s'améliorer pour devenir une meilleure personne, elle n’est pas toujours capable de comprendre ses agissements et retombe continuellement dans ses vieilles habitudes.`,
    //     name:'Menthé'
    // },
    // {
    //     image: '/images/11ARESDESKTOP.png',
    //     description:`Arès est le dieu de la guerre, fils d'Héra et de Zeus et père d'Éros . Sarcastique, agressif et prompt à la colère, il a un caractère égoïste notamment quand il veut que les choses se passent comme il le souhaite. Il entretient une relation ouverte avec Aphrodite et flirte avec Perséphone. Cependant, il reconnaît ses traits négatifs et tente de s'améliorer, en s’excusant auprès de Perséphone. Il a un côté doux et protecteur envers Aphrodite et Héra, il veille sur son entourage et ferait n’importe quoi pour sa famille.`,
    //     name:'Arès'
    // },
    // {
    //     image: '/images/09ARTEMISDESKTOP.jpg',
    //     description:`Artémis est la déesse de la Chasse et membre des déesses de la Virginité éternelle. Colocataire de Perséphone et sœur jumelle d'Apollon, elle est mature, honnête et confiante. Elle est très proche de Perséphone et agit comme une maman et représente la voix de la raison. Cependant, même si elle s'inquiète, elle encourage Perséphone à explorer et à découvrir le mont Olympe par elle-même. Sa force de caractère et sa confiance en ses propres capacités peuvent sembler intimidantes, mais avec ses proches, elle est authentique et se soucie d’eux.`,
    //     name:'Artémis'
    // },
    // {
    //     image: '/images/10HERADESKTOP.jpg',
    //     description:`Héra est la déesse du Mariage et des Femmes, membre de la dynastie des Six Traîtres et épouse de Zeus, ce qui fait d’elle la reine des dieux. Volontaire, empathique, elle n’hésite pas à montrer son caractère lorsqu’une cause lui tient à cœur. Sa hargne peut, par exemple, lui faire brûler le portrait de Zeus en guise de représailles. Elle est présente au côté d’Hadès dans ses difficultés avec Menthé et fait tout ce qui est en son pouvoir pour aider Perséphone et découvrir qui l’a blessée. Sa gentillesse est cependant réservée à ceux qu'elle aime, tous les autres la décrivent comme têtue et résolue dans ses idéaux.`,
    //     name:'Héra'
    // },
    // {
    //     image: '/images/11HERMESDESKTOP.jpg',
    //     description:`Hermès est le dieu du Commerce, de la Richesse et des Voyages. C’est le messager des autres dieux, ainsi que l'un des deux collecteurs d'âmes pour les Enfers. Enjoué, effronté, il adore taquiner ses proches. Avec Perséphone, une vieille connaissance, il se montre très présent et amical. Pour elle et son entourage, il est capable de mettre sa joie de côté et se montre très sérieux lorsqu’on commence à les menacer. Il fait preuve d’une grande perspicacité puisqu’il est capable de deviner et comprendre facilement les motivations et les sentiments des autres.`,
    //     name:'Hermès'
    // },
];